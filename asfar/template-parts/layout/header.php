...
<body <?php body_class(); ?>>
	...
	<div class="mt-loader" id="mt-loader" aria-hidden="true">
	...
	<div class="mt-progress" id="mt-progress" aria-hidden="true"></div>
	<header class="mt-nav" id="mt-nav" data-theme="light">
		<div class="mt-wrap mt-nav__in">
			...
			<div class="mt-nav__side">
				...
				<button class="mt-nav__burger" id="mt-burger" type="button" aria-expanded="false" aria-controls="mt-menu"
	...
	<div class="mt-menu__scrim" id="mt-menuScrim" aria-hidden="true"></div>
	<div class="mt-menu" id="mt-menu" role="dialog" aria-modal="true" aria-hidden="true" aria-label="<?php echo esc_attr( asfar_option( 'menu_label' ) ); ?>">
