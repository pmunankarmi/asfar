...
(async()=>{
 ...
 assert.equal(await page.locator('.hero__slide').count(),3);
 await page.locator('.hero__dot').nth(2).click();
 await page.waitForTimeout(650);
 assert.equal(await page.locator('.hero__dot.is-active').getAttribute('data-i'),'2');
 assert.equal(await page.locator('.hero__slide').nth(2).evaluate(e=>e.classList.contains('is-active')),true);
 await page.locator('.hero__dot').first().click();
 ...
 assert.equal(await page.locator('#menu .menu__links a').count(),8);
 ...
 await page.locator('#dkFaq .dk-faq__btn').first().click();
 assert.equal(await page.locator('#dkFaq .dk-faq__btn').first().getAttribute('aria-expanded'),'true');
 ...
 assert.equal(await page.locator('footer').count(),1);
 assert.equal(await page.locator('#dkTeam .member--opens').count(),19);
